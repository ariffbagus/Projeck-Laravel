...
<body>
    ...
    <section class="d-flex justify-content-center align-items-center " style="height: 100vh;">
        <div class="w-50 bg-info p-3"> <!-- Mengatur lebar form -->
            ...
            <br>
            <form action="{{ url('/dashboard/Mypost/kegiatan/' . $kegiatan->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control @error('body')is-invalid @enderror" rows="7" id="body" name="body" required>{{ old('body') }}</textarea>
                    @error('body')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>    
                ...
                <button type="submit" class="btn btn-primary mt-2">Update Kegiatan</button>
            </form>
        </div>
    </section>
