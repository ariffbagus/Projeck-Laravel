...
<body>
    ...
    <section class="d-flex justify-content-center align-items-center " style="height: 100vh;">
        <div class="w-50 bg-info p-3"> <!-- Mengatur lebar form -->
            ...
            <br>
            <form action="{{ url('/dashboard/Mypost/detail/' . $pengumuman->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <button type="submit" class="btn btn-primary mt-2">Update Berita</button>
            </form>
        </div>
    </section>
